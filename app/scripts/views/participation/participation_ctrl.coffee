...
angular.module('participationViews', ['ngRoute', 'ng-breadcrumbs', 'textAngular', 'xin_listResource',
  ...
  .controller 'DisplayParticipationController', ($scope, $route, breadcrumbs, $routeParams, Backend) ->
    breadcrumbs.options =
      Libelle: $routeParams.participationId
